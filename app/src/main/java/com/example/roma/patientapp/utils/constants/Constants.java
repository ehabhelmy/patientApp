package com.example.roma.patientapp.utils.constants;
...
public class Constants {
    ...
    public static final String REQUEST_STATUS_APPROVED = "1";
    ...
    public static final String DOCTOR_SPEC = "doctorSpeciality";
}
